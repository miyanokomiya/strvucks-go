 ...
 * @param optional nil or *CreateActivityOpts - Optional Parameters:
     ...
     * @param "PhotoIds" (optional.String) -  List of native photo ids to attach to the activity.
...
type CreateActivityOpts struct { 
	...
	PhotoIds optional.String
	Commute optional.Int32
}

func (a *ActivitiesApiService) CreateActivity(ctx context.Context, name string, type_ string, startDateLocal string, elapsedTime int32, localVarOptionals *CreateActivityOpts) (DetailedActivity, *http.Response, error) {
	var (
